...
class Image extends BaseImage
{
    ...
    public function __construct($fileImage, $quality = null, $ratio = null, $base64Data = null)
    {
        ...
        if ($module === null) {
            \Yii::log(\Yii::t('sweelix', '{object} has not been defined', array('{object}' => 'ImageConfig')),
                \CLogger::LEVEL_ERROR, 'sweelix.yii1.web');
    ...
    {
        \Yii::trace(\Yii::t('sweelix', '{class} get instance of image', array('{class}' => __CLASS__)),
            'sweelix.yii1.web');
